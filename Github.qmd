...
- Click "push."  This *should* push changes to github.
- Go to your github repo and verify that it did.

## How to use Github

- Create a résumé using are marked down and store it at get hub
- Publish project code and analyses, plus associated presentations and papers
- Use Github as a public portfolio for you to share your skills with the world!
